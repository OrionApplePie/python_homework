...
str1 = " сложение: 1.5*(-3.00333),  (123---) для действительных чисел тоже работает  -0.29756 + 2.," \
...
res = re.findall("[(\-]*\d*[\.]*\d+[)]*\s*[\+\-\*\/]\s*[(\-]*\d*[\.]*\d+[)]*", str1)
print(res)
for expr in res:
        print(expr, end=" = ")
        print(eval(expr))  # функция eval вычисляет выражениев строке
